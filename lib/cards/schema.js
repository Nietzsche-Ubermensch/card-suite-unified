 ...
 * missing keys (a model may omit nulls) and about unknown keys, which are
 * dropped with a warning rather than failing the extraction — an extra field
 * costs nothing, while losing a correct read of the card costs the user. Wrong
 * types and out-of-range values DO fail: those indicate a real
 * misunderstanding of the card rather than a chatty model.
 *
